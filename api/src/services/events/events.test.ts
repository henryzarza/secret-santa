...
describe('events', () => {
  ...
  scenario('creates a event', async () => {
    const result = await createEvent({
      input: {
        name: 'String',
        date: '2024-02-02T22:53:21.488Z',
        updatedAt: '2024-02-02T22:53:21.488Z',
      },
    })

    expect(result.name).toEqual('String')
    expect(result.date).toEqual(new Date('2024-02-02T22:53:21.488Z'))
    expect(result.updatedAt).toEqual(new Date('2024-02-02T22:53:21.488Z'))
  })
